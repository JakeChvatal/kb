// ......................................................... Number Keypad Layer
  ...
  [_NUMBER] = LAYOUT_planck_grid_wrapper(
    ...
    ___x___, OS_CTL,  GT_C,    AT_B,    ST_A,    _______,  ______________________NUM2________________, ___x___, 
    ___x___, _______, KC_HASH, SM_G,    KC_BSLS, _______,  ______________________NUM3________________, ___x___, 
    ___x___, ___x___, ___x___, ___fn__, ___x___, ___x___, ___x___, KC_0,    TD_EQL,  ___x___, ___x___, ___x___
  ),
#else
  // .-----------------------------------------------------------------------------------.
  // |      |   F  |   E  |   D  |      |      |      |   /  |   7  |   8  |   9  |   *  |
  ...
  // '-----------------------------------------------------------------------------------'
  [_NUMBER] = LAYOUT_planck_grid_wrapper(
    _______, _______, KC_F,    MT_E,    KC_D,    _______, ______________________NUM1________________, _______,
    _______, OS_CTL,  GT_C,    AT_B,    LT_A,    _______, ______________________NUM2________________, _______,
    _______, _______, KC_HASH, MT_X,    S(KC_G), _______, ______________________NUM3________________, _______,
